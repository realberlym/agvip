...
<head>
  ...
  <title>Admin AGVIP | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=$link?>plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Entre com seu e-mail para acessar o painel Adm</p>
...
<!-- iCheck -->
<script src="<?=$link?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
